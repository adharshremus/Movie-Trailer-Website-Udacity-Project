""" stores data of movies and display on website """
import fresh_tomatoes
"""importing the code from media"""
import media         
...
def main():
    ...
    deadpool = media.Movie("Deadpool",
                           "A fast-talking mercenary subjected to rogue"
                           "experiment leaves him with accelerated powers", 
                           "http://bit.ly/2eorTC7",
